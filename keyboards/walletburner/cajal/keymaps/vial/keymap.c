...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_ortho(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_SATD, UG_SATU, _______, UG_VALU,
        _______, _______, _______, _______, MO(3)  , _______, _______, _______, _______, _______, _______, UG_HUED, UG_VALD, UG_HUEU
    ),
