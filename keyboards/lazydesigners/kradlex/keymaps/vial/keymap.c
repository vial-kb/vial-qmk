...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL,   KC_LGUI, KC_RALT, KC_NO,   KC_NO,   LT1_SPC,          KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT
        ),
    [1] = LAYOUT(
        ...
        KC_VOLD,   KC_MUTE, KC_VOLU, KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
        ),
    [2] = LAYOUT(
