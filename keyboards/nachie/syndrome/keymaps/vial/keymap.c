...
void matrix_scan_user(void) { // The very important timer.
    ...
    const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
        ...
        [_FN2] 	=  { ENCODER_CCW_CW(KC_VOLD,  KC_VOLU), ENCODER_CCW_CW(RM_PREV, RM_NEXT), ENCODER_CCW_CW(KC_VOLD,  KC_VOLU) },
        [_FN3]  =  { ENCODER_CCW_CW(KC_VOLD,  KC_VOLU), ENCODER_CCW_CW(RM_PREV, RM_NEXT), ENCODER_CCW_CW(KC_VOLD,  KC_VOLU) },
    };
#endif
