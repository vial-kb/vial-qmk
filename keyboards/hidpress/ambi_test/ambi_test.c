...
void render_layer_state(void) {
    ...
    switch(layer) {
        case 0:
            switch(current_mode) {
                case MODE_MOUSE:     oled_write_P(default_layer_on_mouse, false); break;
                case MODE_SCROLLING: oled_write_P(default_layer_on_scroll, false); break;
                case MODE_CUSTOM_KEYS: oled_write_P(default_layer_on_keycodes, false); break;
                default: oled_write_P(PSTR("MODE: UNKNOWN\n"), false); break;
            }
            break;
        case 1:
            switch(current_mode) {
                case MODE_MOUSE:     oled_write_P(one_layer_on_mouse, false); break;
                case MODE_SCROLLING: oled_write_P(one_layer_on_scroll, false); break;
                case MODE_CUSTOM_KEYS: oled_write_P(one_layer_on_keycodes, false); break;
                default: oled_write_P(PSTR("LAYER 1: UNKNOWN MODE\n"), false); break;
            }
            break;
        case 2:
            switch(current_mode) {
                case MODE_MOUSE:     oled_write_P(two_layer_on_mouse, false); break;
                case MODE_SCROLLING: oled_write_P(two_layer_on_scroll, false); break;
                case MODE_CUSTOM_KEYS: oled_write_P(two_layer_on_keycodes, false); break;
                default: oled_write_P(PSTR("LAYER 2: UNKNOWN MODE\n"), false); break;
            }
            break;
        case 3:
            switch(current_mode) {
                case MODE_MOUSE:     oled_write_P(three_layer_on_mouse, false); break;
                case MODE_SCROLLING: oled_write_P(three_layer_on_scroll, false); break;
                case MODE_CUSTOM_KEYS: oled_write_P(three_layer_on_keycodes, false); break;
                default: oled_write_P(PSTR("LAYER 3: UNKNOWN MODE\n"), false); break;
            }
            break;
        default:
