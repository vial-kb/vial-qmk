...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_right(KC_U, KC_O, KC_Y, KC_I, KC_P, KC_BSPC, KC_J, KC_K, KC_H, KC_L, KC_SCLN, KC_QUOT, KC_COMM, KC_N, KC_DOT, KC_ENT, KC_M, KC_SLSH, KC_RSFT, TMB_MODE, KC_RGUI, KC_RALT, KC_RCTL, KC_EQL, MO(1)),
