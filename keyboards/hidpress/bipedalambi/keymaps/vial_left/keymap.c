...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_left(KC_E, KC_W, KC_R, KC_ESC, KC_Q, KC_T, KC_D, KC_S, KC_F, KC_TAB, KC_A, KC_G, KC_UP, KC_C, KC_X, KC_V, KC_LSFT, KC_Z, KC_B, KC_SPC, KC_LEFT, KC_BTN1, KC_RGHT, KC_LGUI, KC_LCTL, KC_LALT, MO(1), KC_MINS, KC_DOWN),
