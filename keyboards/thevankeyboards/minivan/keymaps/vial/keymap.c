...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRNS,
          ...
          KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_MINS, KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, MS_WHLU, KC_TRNS,
          KC_TRNS, KC_TRNS, KC_NO, KC_0, KC_SPC, MS_WHLL, MS_WHLD, KC_NO, MS_WHLR),

  [2] = LAYOUT(MS_BTN2, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_COLN, RALT(KC_BSPC),
          KC_TRNS, KC_NO, KC_NO, KC_NO, KC_BSPC, KC_NO, KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT, RALT(KC_D),
          KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, MS_BTN1, RALT(KC_LEFT), RALT(KC_RIGHT), MS_UP, RALT(KC_B), RALT(KC_F),
          KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, LALT(KC_DEL), KC_DEL, MS_LEFT, MS_DOWN, KC_NO, MS_RGHT),
