...
bool oled_task_user(void) {
    ...
    if (rgb_matrix_is_enabled() == false) {
        ...
        switch (get_highest_layer(layer_state)) {
            case 0:
                ...
                break;
            case 1:
                oled_write_P(PSTR(" 001 \n"), true);
                break;
            case 2:
                oled_write_P(PSTR(" 002 \n"), true);
                break;
            case 3:
                oled_write_P(PSTR(" 003 \n"), true);
                break;
            case 4:
                oled_write_P(PSTR(" 004 \n"), true);
                break;
            case 5:
                oled_write_P(PSTR(" 005 \n"), true);
                break;
            case 6:
                oled_write_P(PSTR(" 006 \n"), true);
                break;
            case 7:
                oled_write_P(PSTR(" 007 \n"), true);
                break;
            case 8:
                oled_write_P(PSTR(" 008 \n"), true);
                break;
            case 9:
                oled_write_P(PSTR(" 009 \n"), true);
                break;
            case 10:
                oled_write_P(PSTR(" 010 \n"), true);
                break;
            case 11:
                oled_write_P(PSTR(" 011 \n"), true);
                break;
            case 12:
                oled_write_P(PSTR(" 012 \n"), true);
                break;
            case 13:
                oled_write_P(PSTR(" 013 \n"), true);
                break;
            case 14:
                oled_write_P(PSTR(" 014 \n"), true);
                break;
            case 15:
                oled_write_P(PSTR(" 015 \n"), true);
                break;
            default:
