...
* Hardware Supported: waveshare rp2040
 ...
 Note: I've added a vial keymap file you can load that initially and then change it according to your liking. Also I've only made vial version for this keyboard so the default folder just have some random code from another keybaord.
