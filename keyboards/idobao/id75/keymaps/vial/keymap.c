...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [1] = LAYOUT_ortho_5x15(
    ...
    EE_CLR,  KC_BRIU, RGB_SAI, RGB_VAI, RGB_HUI, RGB_SPI, RGB_MOD,  KC_WH_U, MS_BTN1, MS_UP, MS_BTN2, KC_WH_U, KC_NO,   KC_SLEP, KC_WAKE,
    DB_TOGG, KC_BRID, RGB_SAD, RGB_VAD, RGB_HUD, RGB_SPD, RGB_RMOD, KC_WH_D, MS_LEFT, MS_DOWN, MS_RGHT, KC_WH_D, KC_NO,   KC_NO,   KC_HOME,
