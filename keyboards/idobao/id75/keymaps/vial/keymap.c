...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [1] = LAYOUT_ortho_5x15(
    ...
    EE_CLR,  KC_BRIU, RM_SATU, RM_VALU, RM_HUEU, RM_SPDU, RM_NEXT,  MS_WHLU, MS_BTN1, MS_UP, MS_BTN2, MS_WHLU, KC_NO,   KC_SLEP, KC_WAKE,
    DB_TOGG, KC_BRID, RM_SATD, RM_VALD, RM_HUED, RM_SPDD, RM_PREV, MS_WHLD, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD, KC_NO,   KC_NO,   KC_HOME,
    KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   RM_TOGG,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_MUTE, KC_VOLU, KC_END,
