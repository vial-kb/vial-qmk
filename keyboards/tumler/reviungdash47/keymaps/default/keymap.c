...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] = LAYOUT(
    UG_VALU, UG_SATU, UG_HUEU, UG_NEXT, _______, UG_TOGG,            _______, _______, _______, _______, _______, KC_VOLU,
    UG_VALD, UG_SATD, UG_HUED, UG_PREV,_______, _______,            _______, _______, _______, _______, _______, KC_VOLD,
