...
// #define OLED_DISPLAY_128X64 //1288x64 needs this define, for  128x32 display no extra define is needed and this can be removed/commented

// #define OLED_KYRIA_STYLE // self defined, use the kimiko style for the OLED display
#endif
//------------------------------------------
...
//------------------------------------------
	...
	//Cirque Trackpad
		...
		// #define CIRQUE_PINNACLE_X_LOWER 320  //default: 127 // min "reachable" X value
		// #define CIRQUE_PINNACLE_Y_LOWER 200  //default: 63 // min "reachable" Y value
		#define CIRQUE_PINNACLE_Y_UPPER 1451 //default: 1471 //  max "reachable" Y value
		
		#define CIRQUE_TEST_SETTINGS
	#endif
	...
	//Pimoroni Trackball
		...
		#define PIMORONI_TEST_SETTINGS // self defined, use for Pimoroni test settings, here and in keymap.c
	
		#ifdef PIMORONI_TEST_SETTINGS
			#define PIMORONI_TRACKBALL_SCALE 1 //default 5
			#define PIMORONI_TRACKBALL_DEBOUNCE_CYCLES 5 // default 20
			#define POINTING_DEVICE_TASK_THROTTLE_MS 1 // https://github.com/qmk/qmk_firmware/pull/18550 8ms? for new testing driver, 1ms maybe not working on slower uC, like ProMicro board
			#define MOUSE_EXTENDED_REPORT
		#endif			
	#endif
	
	#if defined(CIRQUE_TEST_SETTINGS) || defined(PIMORONI_TEST_SETTINGS)
		#define POINTING_TEST_SETTINGS
	#endif
#endif
#define I2C1_CLOCK_SPEED  400000 //1000000 //400000
//------------------------------------------
...
// possible VIA definitions, not necessarily needed
//------------------------------------------
