...
/*    [STEN] = LAYOUT( \
    STN_KL, STN_PWR, STN_HL, STN_TL, STN_FN, STN_O, STN_N7, STN_DR, STN_LR, STN_FR, STN_ZR, STN_GR,
...
*/
    [STEN] = LAYOUT( \
STN_KL, STN_PWR, STN_HL, STN_TL, STN_FN, STN_O, STN_N7, STN_DR, STN_LR, STN_FR, STN_ZR, STN_GR,
STN_A, STN_S1, STN_PL, STN_ST1, STN_S2, STN_RL, STN_RR, STN_SR, STN_ST3, STN_PR, STN_TR, STN_U,
STN_N1, STN_ST2, STN_WL, STN_BR, STN_ST4, STN_E
    )
};
