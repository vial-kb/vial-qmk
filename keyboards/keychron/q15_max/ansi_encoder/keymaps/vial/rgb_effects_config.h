 ...
 * Expanded RGB effects configuration for Keychron Q15 Max
 *
 * This adds all available RGB Matrix effects to the Vial build
 * Originally from d3lilah's VIA implementation
 */
