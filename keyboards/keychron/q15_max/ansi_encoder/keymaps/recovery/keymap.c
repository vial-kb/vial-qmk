/* Recovery keymap for Q15 Max - based on VIA defaults */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_66(
        ...
        KC_LCTL,  KC_LOPT,  KC_LCMD,  _______,  KC_SPC,                       KC_SPC,             MO(MAC_FN),MO(COM_FN),KC_LEFT, KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_ansi_66(
        RGB_TOG,  KC_BRID,  KC_BRIU,  KC_MSEL,  KC_FIND,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  RGB_TOG,
        KC_GRV,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,                      _______,            _______,  _______,  _______,  _______,  _______),
