...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [1] =   { ENCODER_CCW_CW(RM_HUED, RM_HUEU), ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______)},
    [2] =   { ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______)}
};
#endif
