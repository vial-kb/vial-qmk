...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_F7,            KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_COLN,    KC_DQT,     BL_TOGG, BL_UP,  BL_DOWN,
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_F7,            KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_SCLN, KC_QUOT, _______, _______, KC_DEL,
