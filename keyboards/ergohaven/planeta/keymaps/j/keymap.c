...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [_BASE] = LAYOUT(
         ...
         KC_ESC,  KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,  KC_COMM, KC_DOT, KC_QUOT, KC_MPLY,
           LALT(KC_LSFT),  KC_LSFT, KC_LCTL, LOWER, KC_SPC, KC_LBRC,            KC_RBRC, KC_BSPC, RAISE, KC_RSFT, ADJUST, KC_RGUI 
      ...
      [_ADJUST] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______,
        _______, CK_RST,  CK_DOWN, CK_UP,   CK_TOGG, AU_TOGG,                            _______, KC_MPRV, KC_PGDN, KC_PGUP, KC_MNXT, _______,
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______,
                 _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______                            
       ),
};
