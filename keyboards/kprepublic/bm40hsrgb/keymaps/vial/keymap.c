...
[0] = LAYOUT_planck_mit(
    ...
    RM_TOGG, KC_LCTL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[1] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, _______, MO(3),    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
