...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_PGDN,          KC_LCTL, KC_LGUI, KC_LALT, MO(1),   KC_SPC,  KC_SPC,      KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI, KC_RGUI, KC_RCTL
  ),
  [1] = LAYOUT(
    ...
    BL_STEP,          _______, RGB_SAD, RGB_SAI, _______, _______, _______,     _______, _______, _______, _______,    _______, _______, _______, _______,
